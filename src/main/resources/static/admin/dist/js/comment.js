$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '评论内容', name: 'commentBody', index: 'commentBody', width: 200},
            {label: '评论时间', name: 'commentCreateTime', index: 'commentCreateTime', width: 120},
            {label: '评论人名称', name: 'commentator', index: 'commentator', width: 60},
            {label: '评论人邮箱', name: 'email', index: 'email', width: 100},
